  ...
  <div style="background-color: #e4e6ef; height: 100vh">
    ...
    <div class="card mt-3 mx-3 my-4" style="border-radius: 10px">
      <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
        ...
        <li class="breadcrumb-item pe-3 text-muted mt-4 mb-2">Users</li>
      </ol>
    </div>
                ...
                <div class="row align-items-center">
                  <div class="col-lg-9 col-xl-8">
                    <div class="row align-items-center">
                      ...
                      >
                                    <select style="color:gray;" class="form-select" aria-label="Default select example">
  <option  selected>Please select a device type.</option>
  <option  value="1">Hub</option>
  <option  value="2">UtopicR</option>
  <option  value="3">UtopicRX</option>
  <option  value="3">MidlineWifi</option>
  <option  value="3">Silverline</option>
  <option  value="3">UtopicRClone</option>
  <option  value="3">RfDevice</option>
</select>
                      </div>
                    </div>
                  </div>
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col txt-gr">#</th>
                    <th scope="col txt-gr">Name</th>
                    <th scope="col txt-gr">E-mail</th>
                    <th scope="col txt-gr">Phone Number</th>
                     <th scope="col txt-gr">Transactions</th>
                ...
                <tbody>
                  <tr v-for="person in filteredPeople" :key="person.id">
                    ...
                    <td>{{ person.phone }}</td>
                    <td>
                           <button onclick="load_group_detail(527)" class="rad btn-sm btn-warning" title="Details">
                          <span>Details</span>
                          </button>
                    </td>
                  </tr>
