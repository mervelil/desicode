  ...
  <div class="wrapper">
        <div class="card">
            <form @submit.prevent="login" class="d-flex flex-column">
                <div class="text-center text-black "  style="margin-top:250px;">
                    <img class="mt-4 my-5" src="../assets/images/desi.png" width="200" height="200"/>
                </div>
                <div class="d-sm-flex align-items-sm-center" >
                    <div class="mt-sm-0 mt-3 my-2 mx-auto"><p class="text-center text-secondary" style="font-size:20px;">Forgot password?</p></div>
                </div>
                <div class="d-sm-flex align-items-sm-center ">
                    <div class="mt-sm-0 mt-3"><p class="text-secondary mx-2">Enter your email address for reset password</p></div>
                </div>
               
                <div class="d-flex align-items-center  my-5 mb-1">
                    <span class="far fa-user p-2"></span>
                    <input type="text"  v-model="userLoginText" name="userLoginText" value="userLoginText"   placeholder="Email or Phone " class=" mb-1 form-control mb-1">           
                </div>
         
                <div class="d-sm-flex align-items-sm-center justify-content-sm-between my-4">
                <div class="mb-1">
                    <button type="submit"   class="btn btn-primary mb-1 mx-3">Request</button>
                </div>
                <div class="mb-1">
