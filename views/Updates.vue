  ...
  <div style="background-color: #e4e6ef; height: 100vh">
    ...
    <div class="card mt-3 mx-3 my-4" style="border-radius: 10px">
      <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
        ...
        <li class="breadcrumb-item pe-3 text-muted mt-4 mb-2">Updates</li>
      </ol>
    </div>
          ...
          <div class="col-lg-12 col-xxl-12">
                ...
                <div class="row align-items-center">
                  <div class="col-lg-9 col-xl-8">
                    <div class="row align-items-center">
                      <div class="col-md-4 my-2 my-md-0">
                        <div class="input-icon">
                          <input
                            ...
                            v-model="searchText"
                            placeholder="Ara"
                            id="kt_datatable_access_point_search_query"
                          />
                      ...
                      <div
                        class="col-md-4 my-2 my-md-0 dropdown dropdown-inline mr-2"
                      >
                        <button
                          type="button"
                          onclick="open_add_group_modal()"
                          class="btn rad btn-outline-primary"
                        >
                ...
                <tbody>
                  <tr v-for="person in filteredPeople" :key="person.id">
                    ...
                    <td
                      ...
                      <span style="overflow: visible;position: relative; width: 273px;">
                        <span class="rad-w">
                            {{person.software}}
                          </span>
                          &nbsp;
                          <span  class="rad-s btn-sm">
                             {{person.status}}
                          </span>
                        </span>
                    </td>
                    <td>{{person.hardware}}</td>
                    <td>{{person.path}}</td>
           <td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
            <span style="overflow: visible; position: relative; width: 150px;">
                <div class="dropdown">                      
                      <button class="btn btn-secondary btn-icon btn-sm" type="button" id="operation_62" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">         
                     ...
                     </button>            
                     <div class="dropdown-menu" aria-labelledby="operation_62">
                    <a class="dropdown-item" onclick="activateDeactivate(62,0)" href="javascript:void(0);">Pasife Al</a>
                     <a class="dropdown-item" onclick="openReleaseNotes(62)" href="javascript:void(0);">Güncelleme Notları</a>                                
                     <a class="dropdown-item" onclick="deleteReleaseNote(62)" href="javascript:void(0);">Sil</a>        
                     <a class="dropdown-item" onclick="sendNotification(62)" href="javascript:void(0);">Bildirim Gönder</a>                           
                      </div>
                      </div>
                      </span>
                      </td>
              ...
              <div
                class="d-sm-flex align-items-sm-center justify-content-sm-between"
              >
                <b-pagination
                  v-model="currentPage"
                  :total-rows="people"
