        ...
        <div class="card">
            <form @submit.prevent="login" class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center  my-3 mb-1">
                    ...
                    <input type="text"  v-model="userLoginText" name="userLoginText" value="userLoginText"   placeholder="Username or Email" class=" mb-1 form-control mb-1">
                </div>
                ...
                <div class="d-sm-flex align-items-sm-center justify-content-sm-between">
                    <div class="d-flex align-items-center">
                        <label class="option my-3">
                            <span class="text-light-gray">Remember Me</span>
                ...
                <div class="my-2 mb-1">
                    ...
                    <div class="my-2 mb-1">
                    <button type="submit"  @click="logingoogle()" class="btn btn-primary mb-1">Sign in with Google</button>
                </div>
                <div class="mb-3 my-4">
...
.back {
   background-image: url('../assets/images/giri.png');
