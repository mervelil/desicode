              ...
              <table class="table">
                ...
                <tbody> 
                  <tr v-for="person in filteredPeople" :key="person.id">
                    ...
                    <td> 
                      <div>
                       <button class="rad" @click="gotoDevice()">{{person.details}}</button>
                      </div>
                      </td>
                  </tr>
...
export default {
  ...
  data() {
    return {
      ...
      person: {},
       people: [
        { id: 1, name: 'Test(1 devices)', status: 'Online', details:'details' },
        { id: 2, name: 'Jacob', status: 'Thorton', details: '20' },
        { id: 3, name: 'Larry', status: 'the Bird', details: '28' },
        // ... diğer kişiler ...
      ],
      breadcrumbItems: [
