<template>
  ...
  <option  value="4">MidlineWifi</option>
  <option  value="5">Silverline</option>
  <option  value="6">UtopicRClone</option>
  <option  value="7">RfDevice</option>
</select>
                      </div>
                    </div>
                  </div>
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col txt-gr">Device Type</th>
